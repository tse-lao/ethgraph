import {
  ...
  FormRequestCreated as FormRequestCreatedEvent,
...
export function handleFormRequestCreated(event: FormRequestCreatedEvent): void {
  let entity = new FormRequestCreated(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.formID = event.params.formID
  ...
  entity.submitionReward = event.params.submitionReward
  entity.mintPrice = event.params.mintPrice
  entity.rewardToken = event.params.rewardToken
  entity.formAdmin = event.params.formAdmin
